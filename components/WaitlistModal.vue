    ...
    <Teleport to="body">
      <Transition name="fade">
        <div v-if="isOpen" class="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
          <div class="absolute inset-0 bg-[color-mix(in_srgb,var(--ink)_45%,transparent)]" @click="close" />
          ...
          >
            <div class="flex items-start justify-between gap-6">
              <div>
                <h2 id="waitlist-title" class="text-2xl">Join the waitlist</h2>
                <p class="mt-1.5 text-[0.9375rem] text-muted">We will write when there is a spot.</p>
              </div>
              <button
                type="button"
