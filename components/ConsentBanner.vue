...
// The consent card shown inside a mock "site" frame (used on the Consent page).
</script>
...
<template>
  <figure class="m-0">
    ...
    <div class="relative min-h-[31rem] overflow-hidden rounded-xl border border-border bg-[#F1EEE7] sm:min-h-[27rem]">
