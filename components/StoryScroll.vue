...
const steps = [
  {
    ...
    body: 'A banner in their language. Every choice logged.',
    to: '/consent',
    cta: 'Open Consent',
  },
  {
    ...
    body: 'Policies, status and a named contact. Always current.',
    to: '/trust',
  ...
  },
  {
    ...
    body: 'One portal. A reference number. A 30-day target.',
    to: '/rights',
    cta: 'Open Rights',
  },
]
